...
class RareFragment:Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rare, container, false)
        gridView = view.findViewById(R.id.gridView_rare)
        ...
        collectionViewModel.imageToShowRare.observe(viewLifecycleOwner, Observer {
            imageList = it
